  ...
  return (
    <>
      ...
      {isAuthLoading && !isAuthenticated && (
        <div className="mb-5 flex flex-wrap items-center gap-3 rounded-2xl border border-white/10 bg-white/[0.04] px-3 py-2.5 text-xs text-slate-300 backdrop-blur-xl sm:px-4 sm:py-3 sm:text-sm">
