...
const sheetVariants = cva(
  'fixed z-50 gap-4 border border-ink-700/10 bg-rice-50 p-6 shadow-[var(--shadow-paper-lg)] backdrop-blur-xl ricepaper transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500',
  {
    variants: {
      side: {
